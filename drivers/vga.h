#ifndef __NOTOS__DRIVERS__VGA_H
#define __NOTOS__DRIVERS__VGA_H
...
namespace NotOS
{
    namespace drivers
    {
        ...
        public:
            ...
            virtual void PutPixel(common::uint32_t x, common::uint32_t y, common::uint8_t colorIndex); // TODO: Should be in protected.
        };
    }
}
